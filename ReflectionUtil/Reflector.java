...
public class Reflector {
     ...
     * @author joojn
     */
    public static Reflector For(Class<?> clazz)
    {
     ...
     * @author joojn
     */
    public static Reflector For(String className)
    {
     ...
     * @author joojn
     */
    public static Reflector For(String className, ClassLoader cl)
    {
        try
        {
     ...
     */
    public ExistExpression<Reflector> exists(
    ...
    public class MethodReflector {
        ...
        {
            this(
                findMethod(Reflector.this.clazz, Reflector.this.name, classes)
            );
        }
